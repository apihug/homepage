  ...
  return (
    <div className="mt-20 relative max-w-7xl mx-auto px-4 sm:mt-32 sm:px-6 md:px-8 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:grid-rows-1">
      <div className="lg:col-span-7 xl:col-span-6 lg:row-end-1">
        ...
        <Paragraph>
          Achieve intuitive design and efficient code generation for data models.
          Covering front-end, API, and backend data access layers.
        </Paragraph>
  ...
  return (
    <section id="component-driven">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <BigText>
          <Widont>Streamline your workflow.</Widont>
        </BigText>
        <Paragraph>
        Common Models, Version Control, and Catalog Repository.<br/>
          Maintain a Single Source of Truth, Foster Collaboration, and Streamline Communication within One IDE.
        </Paragraph>
