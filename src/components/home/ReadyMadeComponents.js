  ...
  return (
    <section id="ready-made-components">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <BigText>
          <Widont>Move even faster with ApiHug.</Widont>
        </BigText>
        <Paragraph>
          Rapidly develop enterprise-grade components with pro developer tools, intuitive designers, and code generation.<br/>
