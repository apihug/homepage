...
so since this version of SDK **0.8.6-RELEASE**, we make you really relief from this boring crazy stuff. include [0.7.8](/zhCN-docs/changelog/detail/SDK_0.7.8) re-design the repository maintain way;
