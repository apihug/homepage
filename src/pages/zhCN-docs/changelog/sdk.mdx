---
title: SDK Changelog
description: Changelog of the ApiHug SDK.
---
...
- Support export constant for: `errors`, `dictionaries`,`authorities`
    - `/hope/meta/errors`
    - `/hope/meta/dictionaries`
    - `/hope/meta/authorities`

[English](/zhCN-docs/changelog/detail/SDK_0.8.6) | [简体中文](/zhCN-docs/changelog/detail/SDK_0.8.6_cn)
...
- extract the runtime swagger to cache with name patter: `final String name = groupId + "_" + artifactId + ".json";`
