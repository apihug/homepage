---
title: Milestone of 2024-02-22
description: With SDK [0.6.0-RELEASE] and plugin  [0.2.0]
...
<img src={require('@/img/milestone/milstone02.png').default.src} alt="Milestone February 22, 2024" width={1080} height={758} className="rounded-lg" />
